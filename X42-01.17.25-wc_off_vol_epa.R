...
# load data from 2024 NFL season
...
wcplot11 = ggplot(data = nflwc24, aes(x = plays, y = epaper)) +
  scale_x_continuous(n.breaks = 6) +
  scale_y_continuous(n.breaks = 6) +
  geom_smooth(method = "lm", se = FALSE, color = "grey") +
  geom_hline(yintercept = mean(nflwc24$epaper), linetype = "dashed", color = "red") +
  geom_vline(xintercept = mean(nflwc24$plays), linetype = "dashed", color = "red") +
