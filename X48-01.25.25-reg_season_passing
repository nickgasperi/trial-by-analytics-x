...
# create extra column for future viz
  passerdata$passeryr = paste(passerdata$passer_player_name, passerdata$season,
                              sep = ", ")
